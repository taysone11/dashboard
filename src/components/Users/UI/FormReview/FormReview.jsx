...
export default function FormReview({addComment}) {
    ...
    var datePublicate= myDate.getDate() + "." + Month  + "." + myDate.getFullYear();
    ...
    function addNewReview(e) {
       ...
       if (review.body.length > 0 && review.email.length > 0) {
        const newComment = {
        ...review, id:Date.now(), date: datePublicate
       }
    ...
    return( 
        <div className="user__formReview">
            <form action="" >
                ...
                <div>
                    <button className="userId__btnComment" onClick={addNewReview}>publish</button>
                </div>
            </form>
        <div>
